      ...
      <label className="h-[43px] rounded-full bg-[color:var(--background-third)] w-full relative group border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[#1d9bf0]">
        ...
        {query && focus && (
          <button
            type="button"
            onClick={() => setQuery("")}
            className="h-[22px] w-[22px] rounded-full bg-[color:var(--color-primary)] flex items-center justify-center text-black min-v-[22px] absolute top-1/2 -translate-y-1/2 right-3 invisible group-focus-within:visible"
          >
