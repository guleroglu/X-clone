export const posts = [
  {
    ...
    type: "poll",
    content: `Fenerbahçeyi seviyor musun?`,
    poll: {
      voted: false,
      votes: 12,
      answers: [
    ...
    account: {
      avatar:
        "https://pbs.twimg.com/profile_images/1754973332821176320/NC4wWHdB_bigger.jpg",
      username: "fenerbahce",
      fullName: "Fenerbahce",
    },
    stats: {
  ...
  },
  {
    id: "1708632465282150796",
    type: "photo",
    content: `Down Sendromu bir hastalık değil, genetik farklılıktır. Dünyaya kattığınız +1 değerin farkındayız. 💛 💙`,
    photos: [
      "https://pbs.twimg.com/media/GJLa9hWWsAABml9?format=jpg&name=small",
    ],
    account: {
      avatar:
        "https://pbs.twimg.com/profile_images/1754973332821176320/NC4wWHdB_bigger.jpg",
  ...
  },
  {
    ...
    photos: [
      "https://pbs.twimg.com/media/GJJHeJLXsAAAlw4?format=jpg&name=small",
      "https://pbs.twimg.com/media/GJI5PdzWsAAtP-z?format=jpg&name=small",
    ],
    account: {
      avatar:
...
Prompt in ALT tag + more examples in thread:`,
    photos: [
      "https://pbs.twimg.com/media/GI9kehTW4AAkovs?format=jpg&name=small",
      "https://pbs.twimg.com/media/GI9kehTW4AAkovs?format=jpg&name=small",
      "https://pbs.twimg.com/media/GI9kehTW4AAkovs?format=jpg&name=small",
      "https://pbs.twimg.com/media/GI9kehTW4AAkovs?format=jpg&name=small",
    ],
