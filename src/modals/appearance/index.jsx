        ...
        <div className="grid gap-3">
          <section>
            ...
            <div className="bg-[color:var(--background-secondary)] p-4 rounded-2xl flex items-center gap-5 ">
              ...
              <div className="h-1 bg-[var(--color-secondary)] flex-1 rounded-full relative">
                <div
                  style={{ width: fontSizePercent }}
                  className="absolute h-full top-0 left-0 rounded-full bg-[color:var(--color-primary)]"
                ></div>
                <div className="flex justify-between absolute -top-3.5 -left-[8px] w-[calc(100%+16px)]">
          ...
          <section>
            ...
            <div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
              ...
              <button
                ...
                className={classNames(
                  "h-16 pr-3 pl-2 bg-black text-[#f7f9f9] font-bold border border-white/10 rounded group flex items-center gap-1.5",
                  {
                    "!border-[color:var(--color-primary)] !border-2":
